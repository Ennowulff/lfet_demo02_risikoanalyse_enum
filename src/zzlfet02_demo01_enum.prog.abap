...
DATA default_rechtl_rahmenbed TYPE zcl_lfet02_enum_rule_risikoan=>enum_rechtl_rahmenbedingungen
                              VALUE zcl_lfet02_enum_rule_risikoan=>rechtl_rahmenbedingungen-vorhanden.
DATA default_ressourcen_abh   TYPE zcl_lfet02_enum_rule_risikoan=>enum_ressourcen_abhaengigkeit
                              VALUE zcl_lfet02_enum_rule_risikoan=>ressourcen_abhaengigkeit-int1.
DATA default_projektumfang    TYPE zcl_lfet02_enum_rule_risikoan=>enum_projektumfang
                              VALUE zcl_lfet02_enum_rule_risikoan=>projektumfang-klein.
...
INITIALIZATION.
  ...
  CALL FUNCTION 'VRM_SET_VALUES'
    EXPORTING
      id     = 'P_LEGAL'
      values = VALUE vrm_values( ( key  = zcl_lfet02_enum_rule_risikoan=>rechtl_rahmenbedingungen-vorhanden
                                   text = zcl_lfet02_enum_rule_risikoan=>get_text(
                                              zcl_lfet02_enum_rule_risikoan=>rechtl_rahmenbedingungen-vorhanden ) )
                                 ( key  = zcl_lfet02_enum_rule_risikoan=>rechtl_rahmenbedingungen-unklar
                                   text = zcl_lfet02_enum_rule_risikoan=>get_text(
                                              zcl_lfet02_enum_rule_risikoan=>rechtl_rahmenbedingungen-unklar ) )
                                 ( key  = zcl_lfet02_enum_rule_risikoan=>rechtl_rahmenbedingungen-keine
                                   text = zcl_lfet02_enum_rule_risikoan=>get_text(
                                              zcl_lfet02_enum_rule_risikoan=>rechtl_rahmenbedingungen-keine ) )  ).
    ...
    EXPORTING
      ...
      values = VALUE vrm_values(
          ...
          ( key  = zcl_lfet02_enum_rule_risikoan=>ressourcen_abhaengigkeit-int2plus
            text = zcl_lfet02_enum_rule_risikoan=>get_text(
                       zcl_lfet02_enum_rule_risikoan=>ressourcen_abhaengigkeit-int2plus ) )
          ( key  = zcl_lfet02_enum_rule_risikoan=>ressourcen_abhaengigkeit-ext1plus
            text = zcl_lfet02_enum_rule_risikoan=>get_text(
                       zcl_lfet02_enum_rule_risikoan=>ressourcen_abhaengigkeit-ext1plus ) ) ).
